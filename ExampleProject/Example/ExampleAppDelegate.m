...
@synthesize tableViewWindow, scrollViewWindow;
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
	...
	TUINSView *tuiTableViewContainer;       [tableViewWindow setContentView:tuiTableViewContainer = [TUINSView.alloc initWithFrame:b]];
	tuiTableViewContainer.rootView = [ExampleView.alloc initWithFrame:b];
	/** Scroll View */
	...
	/* TUINSView is the bridge between the standard AppKit NSView-based heirarchy and the TUIView-based heirarchy */
	TUINSView *tuiScrollViewContainer; [scrollViewWindow setContentView:tuiScrollViewContainer = [TUINSView.alloc initWithFrame:b]];
	tuiScrollViewContainer.rootView = [ExampleScrollView.alloc initWithFrame:b];
