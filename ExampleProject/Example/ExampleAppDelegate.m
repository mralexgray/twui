...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
	...
	scrollViewWindow.releasedWhenClosed = FALSE;
	scrollViewWindow.minSize = NSMakeSize(300, 250);
	scrollViewWindow.frameTopLeftPoint = [tableViewWindow cascadeTopLeftFromPoint:CGPointMake(tableViewWindow.frame.origin.x, tableViewWindow.frame.origin.y + tableViewWindow.frame.size.height)];
